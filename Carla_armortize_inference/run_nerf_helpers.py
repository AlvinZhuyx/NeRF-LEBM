...
class NeRF(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.use_viewdirs:
            ...
            #grad_pts, grad_views = torch.autograd.grad(torch.sum(torch.abs(rgb)), [input_pts, input_views])
            #print('pts: ', grad_pts[0])
            #print('views:', grad_views[0])
        else:
